...
////////callbacks
	...
	if(opts.navigation==true){
		fakeHover.append(
			'<div class="camera_prev"><span class="fa fa-angle-up"></span></div>'
			).append(
			'<div class="camera_next"><span class="fa fa-angle-down"></span></div>'
            ).append(
            '<div class="camera_number"><span id="number"></span></div>');
	}
