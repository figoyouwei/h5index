...
<div class="content indent">
    ...
    <div class="thumb-box10">
        <div class="container">
            ...
            <%
				int index = 1;
				DynElement[] dynElementArray = PageUtils.paginationDynList(request, 2);
				for(DynElement dynElement : dynElementArray){
			%>
            <div class="pid-2 thumb-pad5 wow fadeInLeft">
                <div class="thumbnail">
                    <figure><img src="<%=dynElement.getImage_1()%>" alt=""></figure>
                    <div class="caption">
                        <img src="${contextPath}/template/h5013/code/images/quote1.png" alt="">
